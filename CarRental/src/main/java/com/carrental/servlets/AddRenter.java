...
public class AddRenter extends HttpServlet {
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.print("<html>");
		out.println("<head>");
		out.println("<title>Add Renter</title>");
		...
		RenterBean bean=new RenterBean(name, email, password, mobile);
		RenterDao.save(bean);
		out.print("<h4>Renter added successfully</h4>");
		request.getRequestDispatcher("addrenterform.html").include(request, response);
