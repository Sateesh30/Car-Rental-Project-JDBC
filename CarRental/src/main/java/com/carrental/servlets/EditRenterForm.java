...
public class EditRenterForm extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.print("<html>");
		out.println("<head>");
		out.println("<title>Edit Renter Form</title>");
		...
		RenterBean bean=RenterDao.viewById(id);
		
		out.print("<form action='EditRenter' method='post' style='width:300px'>");
